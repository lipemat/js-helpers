...
describe( 'url', () => {
	...
	describe( 'getFragment', () => {
		it( 'returns the fragment of a URL', () => {
			expect(
				getFragment(
					'http://user:password@www.test-this.com:1020/test-path/file.extension#fragment?query=params&more'
				)
			).toBe( '#fragment' );
			expect(
				getFragment(
	...
	describe( 'addQueryArgs', () => {
		it( 'appends args to a URL without query string', () => {
		...
		it( 'appends args to a URL with query string', () => {
		...
		it( 'updates args on a URL with a conflicting query string', () => {
			const url =
		...
		it( 'updates args on a URL with array parameters', () => {
		...
		it( 'returns only the querystring when passed an undefined url', () => {
			const url = undefined;
			const args = {sun: 'true'};
		...
		it( 'adds query args before the url fragment', () => {
		...
		it( 'returns the URL unaffected when there are no query arguments to append', () => {
	...
	describe( 'getQueryArgs', () => {
		it( 'parses simple query arguments', () => {
		...
		it( 'accumulates an array of values', () => {
			const url =
		...
		it( 'accumulates a keyed array of values', () => {
			const url =
		...
		it( 'accumulates an object of values', () => {
			const url =
		...
		it( 'returns an empty object for a URL without a querystring', () => {
		...
		it( 'gracefully handles empty keys and values', () => {
		...
		describe( 'reverses buildQueryString', () => {
			...
			it( 'does not blow up on malformed params', () => {
	...
	describe( 'getQueryArg', () => {
		it( 'gets the value of an existing query arg', () => {
		...
		it( 'does not return a value for an unknown query arg', () => {
			const url = 'https://andalouses.example/beach?foo=bar&bar=baz';
		...
		it( 'does not return what looks like a query arg after the url fragment', () => {
		...
		it( 'gets the value of an array query arg', () => {
